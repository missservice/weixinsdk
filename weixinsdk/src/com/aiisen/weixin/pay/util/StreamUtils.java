...
public class StreamUtils {
	...
	/**
	 * Returns a variant of the given {@link InputStream} where calling {@link InputStream#close() close()} has no
	 * effect.
	 * 
	...
	/**
	 * Returns a variant of the given {@link OutputStream} where calling {@link OutputStream#close() close()} has no
	 * effect.
	 * 
